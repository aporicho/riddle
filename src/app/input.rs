...
pub(super) enum ModalPreview {
    ...
    PiSettings(pi_settings::Preview),
...
impl ModalPreview {
    fn rect(&self) -> HitRect {
        match self {
            ...
            Self::PiSettings(preview) => preview.rect(),
    ...
    fn is_visible(&self) -> bool {
        match self {
            ...
            Self::PiSettings(preview) => preview.is_visible(),
    ...
    fn update(&mut self, point: Point) -> bool {
        match self {
            ...
            Self::PiSettings(preview) => preview.update(point),
    ...
    fn render(&self, surface: &mut Surface, fonts: &FontBook) {
        match self {
            ...
            Self::PiSettings(preview) => preview.render(surface),
    ...
    fn release_gesture(self, end: Point, classified: Option<Gesture>) -> Gesture {
        match self {
            ...
            Self::PiSettings(preview) => preview.release_gesture(end),
