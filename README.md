...
本项目由 Maxime Rivest 的 [`riddle`](https://github.com/MaximeRivest/riddle) 演进而来，并保留原项目历史和 MIT 署名。0.8.4 的正式运行方式是作为 ReMagic 托管的驻留应用；AppLoad、镇纸和旧独占脚本都不是其运行依赖。

## 与上游 riddle 的主要区别

| 方面 | 上游 | MagicPaper 0.8.4 |
|---|---|---|
